...
<div class="login-page">
  <div class="form">
    ...
    <p class="fail-message" v-if="data.error"> Message from server <strong>{{data.error}}</strong></p>

    <div  v-if="data.login" class="success-message"> 
...
.fail-message{
  background-color: rgb(209, 49, 75);
